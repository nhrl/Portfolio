  ...
  return (
    ...
    >
      ...
      >
        ...
        <div onClick={toggleVisibility} className="hidden justify-center items-center bottom-3 right-2 md:bottom-5 md:right-5 rounded-full fixed w-13 h-13 cursor-pointer dark:bg-[#1b2535]">
